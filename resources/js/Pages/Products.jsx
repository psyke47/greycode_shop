...
export default function Products({
    ...
    useEffect(() => {
        // Fetch user's wishlist items if logged in
        if (props.auth?.user) {
            axios
                .get("/wishlist/items")
                .then((response) => {
    ...
    const getActiveFilterCount = () => {
        ...
        const allCategoriesSelected =
            JSON.stringify(appliedFilters.categories.sort()) ===
            JSON.stringify(allCategories.sort());
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Explore our range of development boards, IoT kits,
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div
                            className={`${isFiltersOpen ? "block" : "hidden"} lg:block lg:w-1/4`}
                        >
                            <div className="bg-white rounded-xl shadow-lg p-6 lg:sticky lg:top-6 accent-greycode-light-blue">
                                ...
                                <div className="mb-8">
                                    ...
                                    <div
                                        className={`${openSections.categories || "lg:block"} ${openSections.categories ? "block" : "hidden lg:block"}`}
                                    >
                                ...
                                <div className="mb-8">
                                    ...
                                    <div
                                        className={`${openSections.price || "lg:block"} ${openSections.price ? "block" : "hidden lg:block"}`}
                                    >
                                ...
                                <div className="mb-8">
                                    ...
                                    <div
                                        className={`${openSections.sort || "lg:block"} ${openSections.sort ? "block" : "hidden lg:block"}`}
                                    >
                                        <select
                        ...
                        <div className="lg:w-3/4">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                                ...
                                <div className="text-sm text-gray-600">
                                    Display:
                                    <button className="ml-2 px-3 py-1 bg-blue-100 text-blue-700 rounded-lg">
                                        Grid
                                    </button>
