...
export default function Checkout({ 
  ...
  const [selectedShippingId, setSelectedShippingId] = useState(defaultShipping?.id || 'new')
  const [selectedBillingId, setSelectedBillingId] = useState(defaultBilling?.id || 'new')
                  ...
                  {addresses.length > 0 && (
                    <div className="mb-6">
                      ...
                      >
                        ...
                        {addresses
                          .filter(a => a.address_type === 'Shipping' || a.address_type === 'Both')
                          .map(address => (
                            <option key={address.id} value={address.id}>
                              {address.address_line1}, {address.surburb}, {address.city}
                            </option>
                          ))
                        }
                      </select>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setData('shipping', { ...data.shipping, address_line1: e.target.value })}
                        ...
                        {errors['shipping.address_line1'] && (
                          <p className="mt-1 text-sm text-red-600">{errors['shipping.address_line1']}</p>
                        )}
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <input
                          type="text"
                          value={data.shipping.address_line2}
                          onChange={(e) => setData('shipping', { ...data.shipping, address_line2: e.target.value })}
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          value={data.shipping.surburb}
                          onChange={(e) => setData('shipping', { ...data.shipping, surburb: e.target.value })}
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          placeholder="Sandton"
                        />
                        {errors['shipping.surburb'] && (
                          <p className="mt-1 text-sm text-red-600">{errors['shipping.surburb']}</p>
                        )}
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          value={data.shipping.province}
                          onChange={(e) => setData('shipping', { ...data.shipping, province: e.target.value })}
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        >
                      ...
                      <div>
                        ...
                        {errors['shipping.postal_code'] && (
                          <p className="mt-1 text-sm text-red-600">{errors['shipping.postal_code']}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        type="tel"
                        value={data.shipping.phone_number}
                        onChange={(e) => setData('shipping', { ...data.shipping, phone_number: e.target.value })}
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="0721234567"
                        maxLength="10"
                      />
                      {errors['shipping.phone_number'] && (
                        <p className="mt-1 text-sm text-red-600">{errors['shipping.phone_number']}</p>
                      )}
                    </div>
                    ...
                    <div className="flex items-center space-x-4 pt-2">
                      <label className="flex items-center">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setData('shipping', { ...data.shipping, save_address: e.target.checked })
                          }}
                          className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                        />
                        <span className="ml-2 text-sm text-gray-600">Save this address</span>
                      </label>
                      ...
                      {saveShipping && (
                        <label className="flex items-center">
                          <input
                            type="checkbox"
                            checked={data.shipping.is_default}
                            onChange={(e) => setData('shipping', { ...data.shipping, is_default: e.target.checked })}
                            className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                          />
                    ...
                    {addresses.length > 0 && (
                      <div className="mb-6">
                        ...
                        >
                          <option value="new">+ Use new address</option>
                          {addresses
                            .filter(a => a.address_type === 'Billing' || a.address_type === 'Both')
                            .map(address => (
                              <option key={address.id} value={address.id}>
                                {address.address_line1}, {address.surburb}, {address.city}
                              </option>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setData('billing', { ...data.billing, address_line1: e.target.value })}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                        </div>
                        <div>
                          ...
                          <input
                            type="text"
                            value={data.billing.address_line2}
                            onChange={(e) => setData('billing', { ...data.billing, address_line2: e.target.value })}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            type="text"
                            value={data.billing.surburb}
                            onChange={(e) => setData('billing', { ...data.billing, surburb: e.target.value })}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                        </div>
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setData('billing', { ...data.billing, city: e.target.value })}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <select
                            value={data.billing.province}
                            onChange={(e) => setData('billing', { ...data.billing, province: e.target.value })}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          >
                            {provinces.map(province => (
                              <option key={province} value={province}>{province}</option>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setData('billing', { ...data.billing, postal_code: e.target.value })}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            maxLength="4"
                          />
                        </div>
                      ...
                      <div>
                        ...
                        <input
                          type="tel"
                          value={data.billing.phone_number}
                          onChange={(e) => setData('billing', { ...data.billing, phone_number: e.target.value })}
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          maxLength="10"
                        />
                      </div>
                        ...
                        <label className="flex items-center">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              setData('billing', { ...data.billing, save_address: e.target.checked })
                            }}
                            className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                          />
                          <span className="ml-2 text-sm text-gray-600">Save this address</span>
                  ...
                  <div className="space-y-4">
                    <label className="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-sm text-gray-500">Pay securely with Payfast</p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50">
                      ...
                      />
                      <div className="ml-4">
                        <span className="font-medium text-gray-900">EFT</span>
                    ...
                    {paymentMethod === 'yoco' && (
                      <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                        <p className="text-sm text-gray-600 mb-2">
                          Payfast payment form will appear here (sandbox mode)
                        </p>
                        {/* Yoco will add their iframe here */}
                        <div id="yoco-card-field" className="border border-gray-300 rounded-lg p-3 bg-white">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-gray-900">
                        {cart.shipping > 0 ? `R ${cart.shipping.toFixed(2)}` : 'Free'}
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">VAT (15%)</span>
                      <span className="font-medium text-gray-900">R {cart.vat?.toFixed(2)}</span>
                    </div>
                    
                    {cart.needs_for_free_shipping > 0 && (
                      <div className="mt-2 p-3 bg-blue-50 rounded-lg">
                        <p className="text-xs text-blue-700">
                          Add R {cart.needs_for_free_shipping.toFixed(2)} more for free shipping
                        </p>
                      </div>
                    )}
