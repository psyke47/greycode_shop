...
export default function Tracking({
    ...
    const handleSubmit = (e) => {
        ...
        const isOrderNumber =
            searchValue.startsWith("GC-ORD-") || /^\d+$/.test(searchValue);
        const isTrackingNumber =
            searchValue.startsWith("TRK") ||
            /^[A-Z0-9]{10,}$/.test(searchValue);
    ...
    return (
        <MainLayout>
            ...
            <meta
                name="description"
                content="Track your order status with your order ID or tracking number. Get real-time updates on shipping and delivery."
            />
            ...
            <section className="py-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-center mb-12">
                        <h1 className="text-4xl font-bold text-greycode-dark-blue mb-2">
                            Track Your Order
                        </h1>
                        <p className="text-gray-600">
                            Enter your tracking number or order ID to check the
                            status
                        </p>
                    </div>
                    ...
                    <div className="max-w-2xl mx-auto mb-12">
                        <div className="bg-white rounded-2xl shadow-md p-8 shadow-greycode-dark-blue">
                      ...
                      Only needed if you placed the order as a guest
                                    ...
                                    <button
                                        ...
                                        disabled={
                                            processing ||
                                            isLoading ||
                                            !data.search_input.trim()
                                        }
                                        className="w-full bg-greycode-light-blue text-white py-3 px-6 rounded-lg font-bold text-lg hover:bg-greycode-dark-blue transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                                    >
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                                        <div>
                                            ...
                                            <div className="flex items-center space-x-4">
                                                <span
                                                    className={`px-4 py-2 rounded-full text-lg font-bold ${getStatusColor(trackingInfo.status)}`}
                                                >
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="border-t border-gray-200 pt-4">
                                                <div className="flex justify-between text-lg font-bold">
                                                    ...
                                                    <span>
                                                        {trackingInfo.currency}{" "}
                                                        {trackingInfo.orderTotal.toFixed(
                                                            2,
                                                        )}
                                                    </span>
                                                </div>
            ...
            `}>
                                    <div className="bg-white p-6 rounded-xl h-full">
                                        ...
                                        <p className="text-gray-600 text-sm">
                                            Look for your order confirmation
                                            email containing your Order ID and
                                            tracking number.
                                        </p>
                                    </div>
                                    ...
                                    {!auth?.user && (
                                        <div className="bg-white p-6 rounded-xl h-full">
                                            ...
                                            <p className="text-gray-600 text-sm">
                                                If you have an account, all your
                                                orders are available in your
                                                order history.
                                            </p>
                                        </div>
                                    )}
                                    ...
                                    <div className="bg-white p-6 rounded-xl h-full">
                                        ...
                                        <p className="text-gray-600 text-sm">
                                            Can't find your order? Our support
                                            team is here to help you locate it.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8">
                                    <Link
                                        href="/contact"
                                        className="inline-block bg-greycode-light-blue text-white py-3 px-6 rounded-lg font-semibold hover:bg-greycode-dark-blue transition-colors duration-300"
                                    >
