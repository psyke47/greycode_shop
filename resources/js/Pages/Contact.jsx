            ...
            <div className="flex flex-col lg:flex-row gap-40 items-center">            
                <div className="bg-white shadow-lg rounded-lg p-8 max-w-3xl w-full">  
                    <form className="max-w-2xl">
                        ...
                        <button type="submit" className="bg-greycode-light-blue text-white px-6 py-3 rounded-xl text-lg font-medium hover:bg-indigo-700 transition ">Send Message</button>
                    </form>
                    </div> 
                    ...
                    <div className="bg-gray-200 rounded-lg p-8 max-w-md w-full text-center mt-12 lg:mt-0">
                        ...
                        <p className="text-lg text-gray-600  mb-6 text-left">
                            ...
                            <MailIcon className="inline-block w-5 h-5 text-blue-600 mr-2" />
